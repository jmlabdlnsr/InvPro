...
if(
    ...
    $rowCount = $barang->update();
    if($rowCount > 0) {
        http_response_code(200);
        echo json_encode(array("message" => "Barang berhasil diperbarui."));
    } else {
        // rowCount bisa 0 jika ID tidak ada ATAU jika user tidak mengubah data sama sekali
        http_response_code(404);
        echo json_encode(array("message" => "Gagal update. ID tidak ditemukan atau tidak ada data yang berubah."));
    }
} else {
